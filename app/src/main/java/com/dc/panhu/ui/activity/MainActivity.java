...
import com.dc.panhu.ui.adapter.CommonFragmentPagerAdapter;
...
import com.dc.panhu.ui.fragment.FragmentFactory;
import com.dc.panhu.ui.presenter.MainAtPresenter;
import com.dc.panhu.ui.radar.RadarPopupWindow;
import com.dc.panhu.ui.view.IMainAtView;
import com.dc.panhu.util.PopupWindowUtils;
...
public class MainActivity extends BaseActivity<IMainAtView, MainAtPresenter> implements ViewPager.OnPageChangeListener, IMainAtView, View.OnClickListener {
    ...
    private LinearLayout llContactss;
    //底部
    @Bind(R.id.llMessage)
    ...
    public void initView() {
        ...
        llContactss = (LinearLayout) findViewById(R.id.llContactss);
        llContactss.setOnClickListener(this);
        //等待全局数据获取完毕
         this.showWaitingDialog(UIUtils.getString(R.string.please_wait));
        llContactss.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                ...
                Toast.makeText(mActivity,"正在扫描盘友",Toast.LENGTH_SHORT).show();
                return true;
            }
        });

        llContactss.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (mRadarPopupWindow != null && mRadarPopupWindow.isShowing()) {
                        mRadarPopupWindow.scanFinished();
                    }
                }
                return false;
            }
    ...
    public void bottomBtnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.llContacts:
                ...
                break;
            case R.id.llContactss:
                mTvContactsPresss.getBackground().setAlpha(255);
                mpanhu.setTextColor(Color.argb(255, 69, 192, 26));
                break;
