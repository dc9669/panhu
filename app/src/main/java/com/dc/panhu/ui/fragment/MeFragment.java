...
import com.dc.panhu.ui.activity.MyInfoActivity;
...
import com.dc.panhu.ui.activity.SettingActivity;
import com.dc.panhu.ui.base.BaseFragment;
import com.dc.panhu.ui.presenter.MeFgPresenter;
import com.dc.panhu.ui.view.IMeFgView;
...
public class MeFragment extends BaseFragment<IMeFgView, MeFgPresenter> implements IMeFgView {
    ...
    public void initView(View rootView) {
        ...
        mOivAlbum.setOnClickListener(v -> ((MainActivity) getActivity()).jumpToWebViewActivity(AppConst.WeChatUrl.MY_QIQU));//奇趣百科
        mOivCollection.setOnClickListener(v -> ((MainActivity) getActivity()).jumpToWebViewActivity(AppConst.WeChatUrl.MY_WEIBO));
        mOivWallet.setOnClickListener(v -> ((MainActivity) getActivity()).jumpToWebViewActivity(AppConst.WeChatUrl.MY_SHENGHUO));
